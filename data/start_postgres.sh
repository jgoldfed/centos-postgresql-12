...
postgresql_server () {
    /usr/pgsql-$PGVERSION/bin/postgres -D /var/lib/pgsql/$PG_VERSION/data -p $PG_PORT
}
...
####
create_dbuser
echo "Starting PostgreSQL $PGVERSION server..."
#postgresql_server
__run_supervisor
